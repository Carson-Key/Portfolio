	...
	return (
		<>
			...
			<div className="flex justify-center my-auto mx-auto lg:mx-3">
				<h1 className="my-auto text-lg font-helvetica lg:text-2xl">Carson</h1>
				<img src={Logo512} className="h-10 ml-1 lg:h-14" alt="" />
				<h1 className="my-auto text-lg font-helvetica ml-1 lg:text-2xl">Key</h1>
			</div>
		</>
	)
}
