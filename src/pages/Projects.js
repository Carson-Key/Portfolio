    ...
    return (
		<Container className="flex flex-wrap justify-evenly">
			<ProjectCard
				...
				background="In my time at OSU Cascades, I learned that one of the best ways to show a potential employer your abilities is in the form of a website. Although I wanted to go a step further and make a portfolio that would both display my accomplishments and experiences, but to also act as one."
				longDescription="From a design perspective this is overkill, a portfolio website is as static of a website as they should come. HTML and Tailwind would have done the job at a far better labor cost. But I decided that the extra costs in design, testing, and implementation would outweigh their costs by providing a far more presentable portfolio with a better display of my skills."
				techDescription="In this project I used React for a responsive and interactive frontend, React-Scripts for a testing suite, and Tailwind for a CSS library. With plans to implement an AWS Amplify backend, once this project is out of the MVP stage."
				projectLink="/"
			...
			<ProjectCard
				...
				longDescription="This project, like most, ended up taking a lot more work than originally thought. I needed to learn how to use the chrome extension library to scrap a website, and then I needed to learn how Roll20 handled its data in the DOM without the source code. This posed a pretty difficult problem, of working entirely in the DOM. Ultimately I made something I'm very proud of, something that can be refactored for other aspects of the game with ease, and a better understanding/appreciation of the DOM."
			...
			<ProjectCard
				...
				imageSrc={LogoOSU}
				imageAlt={"A crest containing the shining sun over the water, the mountains with the stars above them, and a pine tree overlaying a book. With a beaver on top of the crest"}
				shortDescription="The front end of a fake music streaming platform"
				...
				longDescription="This specific project is just the front end portion of the whole project. However, to start the class out, I made a basic login screen using React and Firebase. Then later, after learning how to develop in AWS, I added UI to display artists and then their albums/songs. All of which was based on a very basic wireframe provided by the professor."
			...
			<ProjectCard
				...
				background="The main idea in this class was to have a single project that we would work on the entire three month term, and I had a lot of fun with it. With the main goal to teach us how to make a cloud based application."
				longDescription="This part of the CS 493 project was the backend, which was mainly just the endpoints that the front end uses. This includes getting all artists, all their albums, then all the songs. It also included all AWS management, including IAM user management to secure access to the project and all AWS services. Most of which was all done using cloud formation. However, my favorite part of this class was learning NoSQL access patterns. We used AWS' DynamoDB and a primary/secondary key combo for data consistency."
				techDescription="The tech stack for this project was: Serverless (express) for the lambda framework, firebase admin to check auth token from the front end, DynamoDB for a db, S3 to store songs, and AWS' javascript library to access services."
				education="/"
